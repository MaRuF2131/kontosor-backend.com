...
export const security = (app) => {
  ...
  app.use(
    cors({
      origin: ["http://localhost:3000","http://localhost:3001",'http://localhost:5173',"https://kontosor-admin-com.vercel.app","https://com-liard.vercel.app","https://www.konthoshor.com"],
      credentials: true,
